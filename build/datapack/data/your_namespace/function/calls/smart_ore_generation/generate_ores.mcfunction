...
execute if score #dimension smart_ore_generation.data matches 0.. run function your_namespace:calls/smart_ore_generation/veins/steel_ore
execute if score #dimension smart_ore_generation.data matches 0.. run function your_namespace:calls/smart_ore_generation/veins/steel_ore
...
execute if score #dimension smart_ore_generation.data matches 0.. run function your_namespace:calls/smart_ore_generation/veins/deepslate_steel_ore
execute if score #dimension smart_ore_generation.data matches 0.. run function your_namespace:calls/smart_ore_generation/veins/deepslate_steel_ore
